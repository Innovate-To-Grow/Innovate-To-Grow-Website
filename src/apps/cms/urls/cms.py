...
from apps.cms.views.cms import CMSEmbedHostsView, CMSHomepageView, CMSLivePreviewView, CMSPageView, CMSPreviewFetchView
...
urlpatterns = [
    ...
    path("homepage/", CMSHomepageView.as_view(), name="cms-homepage"),
