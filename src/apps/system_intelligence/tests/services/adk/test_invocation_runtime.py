...
class SystemIntelligenceADKInvocationTests(TestCase):
    ...
    def test_sync_stream_wraps_bedrock_dns_error(self):
        ...
        with patch(
            "apps.system_intelligence.services.adk._invoke_system_intelligence_stream_async", new=failing_async_stream
        ):
            events = list(
                invoke_system_intelligence_stream(
    ...
    def test_sync_stream_loads_configs_before_entering_async_context(self):
        ...
        with patch(
            "apps.system_intelligence.services.adk._invoke_system_intelligence_stream_async", new=fake_async_stream
        ):
