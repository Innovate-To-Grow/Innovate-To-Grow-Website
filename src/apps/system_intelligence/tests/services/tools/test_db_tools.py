...
from apps.core.services.db_tools.tool_modules.executor import execute_tool
...
class ExecuteToolDispatchTests(TestCase):
    ...
    @patch("apps.core.services.db_tools.tool_modules.executor.TOOL_REGISTRY", {"boom": lambda p: 1 / 0})
