...
from apps.system_intelligence.admin.adk_web import AdminADKWebAuthMiddleware
from apps.system_intelligence.admin.adk_web.auth import _rewrite_user_path
...
class AdminADKWebAuthMiddlewareTests(SimpleTestCase):
    def test_browser_shell_redirects_anonymous_user_to_admin_login(self):
        ...
        messages = asyncio.run(invoke_http(app, {"path": "/dev-ui/", "root_path": "/admin/system-intelligence/adk"}))
