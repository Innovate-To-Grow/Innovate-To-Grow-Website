    ...
    def test_prepare_browser_assets_skips_copy_when_stamp_matches(self):
        with TemporaryDirectory() as temp_dir:
            ...
            with (
                ...
                mock.patch("apps.system_intelligence.admin.adk_web.app.shutil.copytree") as copytree,
            ):
                browser_assets_dir = _prepare_browser_assets(runtime_dir, str(fast_api_file))
    ...
    def test_prepare_browser_assets_copies_while_holding_runtime_lock(self):
        with TemporaryDirectory() as temp_dir:
            ...
            with (
                ...
                mock.patch("apps.system_intelligence.admin.adk_web.app._browser_assets_lock", side_effect=fake_lock),
                mock.patch("apps.system_intelligence.admin.adk_web.app.shutil.copytree", side_effect=fake_copytree),
            ):
                _prepare_browser_assets(runtime_dir, str(fast_api_file))
    ...
    def test_prepare_browser_assets_recopies_when_stamp_changes(self):
        with TemporaryDirectory() as temp_dir:
            ...
            with (
                ...
                mock.patch(
                    "apps.system_intelligence.admin.adk_web.app.shutil.copytree", wraps=shutil.copytree
                ) as copytree,
            ):
                _prepare_browser_assets(runtime_dir, str(fast_api_file))
