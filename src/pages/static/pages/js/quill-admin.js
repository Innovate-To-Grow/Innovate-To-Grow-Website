/**
 * Quill Editor Admin Integration
 * Initializes Quill editor and handles popup window preview functionality
 */
...
(function() {
    ...
    function initQuillEditor() {
        ...
        console.log('Quill editor initialized with image alignment');
    }
    ...
    function setupPopupButton() {
        const btn = document.getElementById('popup-preview-btn');
        if (btn) {
