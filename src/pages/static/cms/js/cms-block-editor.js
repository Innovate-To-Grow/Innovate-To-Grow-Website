...
(function () {
  ...
  function renderFaqListFields(data, idx) {
    ...
    return textField('Heading', data.heading, idx, 'heading') +
      ...
      }, function () { return { question: '', answer_html: '' }; });
  }
  ...
  function renderLinkListFields(data, idx) {
    ...
    return '<div class="cms-block-field-row">' +
      ...
      }, function () { return { label: '', url: '', description: '', is_external: false }; });
  }
  ...
  function renderCtaGroupFields(data, idx) {
    ...
    return renderRepeater('CTA Buttons', items, idx, 'items', function (item, itemIdx) {
      return '<div class="cms-block-field-row">' +
        ...
        '</div>';
    }, function () { return { label: '', href: '', style: '' }; });
  }
    ...
    return textField('Heading', data.heading, idx, 'heading') +
      renderRepeater('Contacts', items, idx, 'items', function (item, itemIdx) {
        return '<div class="cms-block-field-row">' +
          ...
          '</div>';
      }, function () { return { label: '', value: '', type: 'email' }; });
  }
  ...
  function renderSectionGroupFields(data, idx) {
    ...
    return textField('Heading', data.heading, idx, 'heading') +
      ...
      }, function () { return { heading: '', heading_level: '', body_html: '' }; });
  }
  ...
  function renderProposalCardsFields(data, idx) {
    ...
    return textField('Heading', data.heading, idx, 'heading') +
      ...
      }, function () { return { type: '', title: '', organization: '', background: '', problem: '', objectives: '' }; });
  }
  ...
  function renderNavigationGridFields(data, idx) {
    ...
    return textField('Heading', data.heading, idx, 'heading') +
      ...
      }, function () { return { title: '', url: '', description: '', is_external: false }; });
  }
  ...
  function getRepeaterDefault(blockType, fieldName) {
    var defaults = {
      'faq_list.items': function () { return { question: '', answer_html: '' }; },
      'link_list.items': function () { return { label: '', url: '', description: '', is_external: false }; },
      'cta_group.items': function () { return { label: '', href: '', style: '' }; },
      'contact_info.items': function () { return { label: '', value: '', type: 'email' }; },
      'section_group.sections': function () { return { heading: '', heading_level: '', body_html: '' }; },
      'table.columns': function () { return ''; },
      'numbered_list.items': function () { return ''; },
      'proposal_cards.proposals': function () { return { type: '', title: '', organization: '', background: '', problem: '', objectives: '' }; },
      'navigation_grid.items': function () { return { title: '', url: '', description: '', is_external: false }; },
    };
