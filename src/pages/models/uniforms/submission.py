...
class FormSubmission(ProjectControlModel):
    ...
    submission_uuid = models.UUIDField(
        default=uuid.uuid4, editable=False, unique=True, help_text="Unique identifier for this submission"
    )
    ...
    # Submission Data
    data = models.JSONField(help_text="Complete form submission data as key-value pairs")
    ...
    reviewed_at = models.DateTimeField(null=True, blank=True, help_text="When this submission was reviewed")

    # Security & Metadata
    ip_address = models.GenericIPAddressField(null=True, blank=True, help_text="IP address of the submitter")
    user_agent = models.TextField(blank=True, help_text="Browser user agent string")
    referrer = models.URLField(blank=True, null=True, max_length=500, help_text="Page the user came from")
