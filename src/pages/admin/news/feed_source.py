...
class NewsFeedSourceAdmin(ModelAdmin):
    ...
    def article_count_display(self, obj):
        ...
        url = reverse("admin:pages_newsarticle_changelist") + f"?source={obj.source_key}"
    ...
    def sync_all_feeds(self, request):
        ...
        if not sources.exists():
            ...
            return HttpResponseRedirect(reverse("admin:pages_newsfeedsource_changelist"))
    ...
    def sync_this_feed(self, request, object_id):
        ...
        if not source.is_active:
            ...
            return HttpResponseRedirect(reverse("admin:pages_newsfeedsource_change", args=[object_id]))
