...
from pages.services.news.feed_parser import extract_image_url, extract_summary, parse_pub_date
from pages.services.news.scraper import scrape_article
...
class ScraperTest(TestCase):
    @patch("pages.services.news.scraper.urllib.request.urlopen")
...
class SyncNewsTest(TestCase):
    @patch("pages.services.news.sync.scrape_article", side_effect=Exception("scrape error"))
    @patch("pages.services.news.sync.fetch_feed")
    ...
    @patch("pages.services.news.sync.scrape_article")
    @patch("pages.services.news.sync.fetch_feed")
    ...
    @patch("pages.services.news.sync.scrape_article", side_effect=Exception("scrape error"))
    @patch("pages.services.news.sync.fetch_feed", side_effect=Exception("Network error"))
