...
from cms.services.analytics.buffer import _BATCH_SIZE, enqueue, flush_sync
...
class PageViewBufferTest(TestCase):
    ...
    def test_auto_flush_triggered_at_batch_size(self):
        ...
        with patch("cms.services.analytics.buffer.threading.Thread") as mock_thread_cls:
    ...
    @patch("cms.services.analytics.buffer._MAX_BUFFER_SIZE", 5)
