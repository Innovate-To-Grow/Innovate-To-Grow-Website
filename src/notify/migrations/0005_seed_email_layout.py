...
DEFAULT_LAYOUT_HTML = """<!doctype html>
<html lang="en">
  <head>
    <meta charset="utf-8">
...
def seed_layout(apps, schema_editor):
    ...
    layout, _ = EmailLayout.objects.get_or_create(
        key="base",
        defaults={
            "name": "Base Email Layout",
            "description": "Default HTML wrapper used for all emails.",
    ...
    EmailMessageLayout.objects.filter(layout__isnull=True).update(layout=layout)


class Migration(migrations.Migration):

    dependencies = [
        ("notify", "0004_email_layouts"),
    ]
