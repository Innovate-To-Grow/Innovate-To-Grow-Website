...
import notify.models.consent.unsubscribe
import uuid
...
class Migration(migrations.Migration):
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "name",
                    models.CharField(
                        help_text="Human-readable name for this layout.", max_length=128
                    ),
                ),
                (
                    "description",
            ...
            options={
                ...
                "ordering": ["name"],
                "indexes": [
                    models.Index(fields=["key"], name="notify_emai_key_792b31_idx"),
                    models.Index(
                        fields=["is_active"], name="notify_emai_is_acti_e0dbb1_idx"
                    ),
                    models.Index(
                        fields=["is_default"], name="notify_emai_is_defa_2683de_idx"
                    ),
                ],
            },
        ),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    ...
                    models.JSONField(
                        blank=True,
                        default=notify.models.consent.unsubscribe.default_metadata,
        ...
        migrations.AddIndex(
            ...
            index=models.Index(fields=["key"], name="notify_emai_key_d68fd7_idx"),
        ),
        migrations.AddIndex(
            model_name="emailmessagelayout",
            index=models.Index(
                fields=["is_active"], name="notify_emai_is_acti_6e3b7d_idx"
            ),
        ),
