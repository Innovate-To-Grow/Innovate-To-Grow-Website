...
from .model_helpers import fetch_foundation_models, profile_base_model_ids, provider_from_id

logger = logging.getLogger(__name__)

MODEL_CACHE_KEY = "bedrock_available_models"
MODEL_CACHE_TTL = 600
FALLBACK_MODELS = [("Anthropic Claude", [("us.anthropic.claude-sonnet-4-20250514-v1:0", "Claude Sonnet 4")])]
...
def fetch_models_from_aws():
    ...
    return grouped if grouped else FALLBACK_MODELS
