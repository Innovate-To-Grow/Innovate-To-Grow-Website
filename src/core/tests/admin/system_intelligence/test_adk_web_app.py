...
from core.admin.system_intelligence.adk_web.app import (
    _adk_allow_origins,
    _get_runtime_dir,
    ...
    def test_prepare_browser_assets_copies_while_holding_runtime_lock(self):
        with TemporaryDirectory() as temp_dir:
            ...
            with (
                ...
                mock.patch("core.admin.system_intelligence.adk_web.app._browser_assets_lock", side_effect=fake_lock),
                mock.patch("core.admin.system_intelligence.adk_web.app.shutil.copytree", side_effect=fake_copytree),
            ):
                _prepare_browser_assets(runtime_dir, str(fast_api_file))
