...
from system_intelligence.admin.adk_web.bridge import adk_http_view
...
class SystemIntelligenceADKHTTPBridgeTests(SimpleTestCase):
    def test_bridge_routes_admin_adk_path_to_asgi_app(self):
        ...
        with mock.patch("system_intelligence.admin.adk_web.bridge._get_bridge_app", return_value=app):
