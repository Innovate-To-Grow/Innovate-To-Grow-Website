"""
Mobile ID related admin configuration.
Includes Barcode, MobileID, and Transaction.
"""
...
class BarcodeAdmin(admin.ModelAdmin):
    ...
    fieldsets = (
        (None, {
            'fields': ('model_user', 'barcode_type', 'barcode')
        }),
        (_('Profile'), {
            'fields': ('profile_name', 'profile_information_id', 'profile_img'),
            'classes': ('collapse',)
        }),
        (_('Metadata'), {
            'fields': ('barcode_uuid', 'time_created'),
            'classes': ('collapse',)
        }),
    )
...
class MobileIDAdmin(admin.ModelAdmin):
    ...
    fieldsets = (
        (None, {
            'fields': ('model_user', 'user_barcode', 'user_mobile_id_server')
        }),
    )
