...
from mail.admin.campaign.views.status import _short_error
from mail.admin.campaign.widgets import TicketSelectWidget
from mail.models import SmsCampaign, SmsRecipientLog
from mail.models.sms_campaign import SMS_AUDIENCE_CHOICES, SMS_EXCLUDE_AUDIENCE_CHOICES
from mail.services.personalize import personalize
from mail.services.sms_audience import get_sms_recipients
...
class SmsCampaignAdmin(BaseModelAdmin):
    ...
    def _background_send(campaign_pk, user_pk):
        ...
        from mail.models import SmsCampaign as CampaignModel
        from mail.services.send_sms_campaign import send_sms_campaign
