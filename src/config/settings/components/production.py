...
# Explicit environment values override the active admin configuration. Missing
# values inherit it. Keep raw values so the service rejects invalid policy
# rather than silently falling back to observe or weaker numeric defaults.
SEND_VERIFICATION_MODE = os.environ.get("SEND_VERIFICATION_MODE")
SEND_VERIFICATION_HMAC_SECRET = os.environ.get("SEND_VERIFICATION_HMAC_SECRET")
SEND_VERIFICATION_HMAC_KEY_SECRET = os.environ.get("SEND_VERIFICATION_HMAC_KEY_SECRET")
SEND_VERIFICATION_HMAC_SECRET_PREVIOUS = os.environ.get("SEND_VERIFICATION_HMAC_SECRET_PREVIOUS")
SEND_VERIFICATION_HMAC_KEY_SECRET_PREVIOUS = os.environ.get("SEND_VERIFICATION_HMAC_KEY_SECRET_PREVIOUS")
SEND_VERIFICATION_ALGORITHM = os.environ.get("SEND_VERIFICATION_ALGORITHM")
SEND_VERIFICATION_COST = os.environ.get("SEND_VERIFICATION_COST")
SEND_VERIFICATION_TTL_SECONDS = os.environ.get("SEND_VERIFICATION_TTL_SECONDS")
SEND_VERIFICATION_MAX_PAYLOAD_BYTES = os.environ.get("SEND_VERIFICATION_MAX_PAYLOAD_BYTES")
SEND_VERIFICATION_DESTINATION_HOURLY_LIMIT = os.environ.get("SEND_VERIFICATION_DESTINATION_HOURLY_LIMIT")
SEND_VERIFICATION_DESTINATION_COOLDOWN_SECONDS = os.environ.get("SEND_VERIFICATION_DESTINATION_COOLDOWN_SECONDS")
