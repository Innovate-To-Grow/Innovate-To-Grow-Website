class member_roster:
    def __init__(self, id, first_name, last_name, primary_email, secondary_email, primary_email_status, secondary_email_status, info_completed, primary_subscribe, secondary_subscribe, organization=None, phonenumber=None, titlerole=None):
        self.id = id
        ...
        self.primary_subscribe = primary_subscribe
        self.secondary_subscribe = secondary_subscribe
