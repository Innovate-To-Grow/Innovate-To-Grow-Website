...
#         "PRIMARY EMAIL NOT UPDATED IN SET UP IN EVENT SHEET"
#     )
#     assert event_row["Membership Secondary"] == secondary_email, (
#         "SECONDARY EMAIL NOT UPDATED IN SET UP IN EVENT SHEET"
#     )
#     assert event_row["First Name"] == first_name, (
#         "FIRST NAME NOT UPDATED IN SET UP IN EVENT SHEET"
#     )
#     assert event_row["Last Name"] == last_name, (
#         "LAST NAME NOT UPDATED IN SET UP IN EVENT SHEET"
#     )
#     assert event_row["When Started"] == start, (
#         "WHEN STARTED NOT UPDATED IN SET UP IN EVENT SHEET"
#     )
#     assert event_row["Last Updated"] == update, (
#         "WHEN UPDATED NOT UPDATED IN SET UP IN EVENT SHEET"
#     )
#     assert event_row["Ticket Type"] == ticket, (
#         "TICKET NOT UPDATED IN SET UP IN EVENT SHEET"
#     )

#     counter = 1
#     for question in questions:
#         assert event_row[question] == base_answer + str(counter), (
#             f"QUESTION {counter} NOT UPDATED IN SET UP"
#         )
#         counter += 1
...
#         found_secondary_email = soup.find("input", {"name": "secondary_email"})["value"]  # type: ignore
#         found_register_event = soup.find("input", {"name": "register_event"})["value"]  # type: ignore
#         found_checked_ticket = soup.find(
#             "input", {"name": "event_tickets", "checked": ""}
#         )["value"]  # type: ignore
#         found_questions = soup.find_all(
#             "input", attrs={"name": re.compile(r"^event_Test")}
#         )
...
#         assert question["value"] == base_answer + str(counter), (
#             f"QUESTION {counter} does not match"
#         )  # type: ignore
# counter += 1
...
#         )
#         assert row["Secondary Email"] == primary_email, (
#             "sec email wrong in members sheet"
#         )
#         event_records = get_wks_records(event_wks)
#         row = event_records[0]
#         assert row["Membership Primary"] == secondary_email, (
#             "Primary email wrong in event sheet"
#         )
#         assert row["Membership Secondary"] == primary_email, (
...
#         records = get_wks_records(wks)
#         row = records[0]
#         assert row["Primary Email"] == primary_email2, (
#             "prim email wrong in members sheet"
#         )
#         assert row["Secondary Email"] == secondary_email, (
#             "sec email wrong in members sheet"
...
#         event_records = get_wks_records(event_wks)
#         event_row = event_records[0]
#         assert event_row["Membership Primary"] == primary_email2, (
#             "Primary email wrong in event sheet"
#         )
#         assert event_row["Membership Secondary"] == secondary_email, (
#             "Secondary email wrong in event sheet"
...
#             "Primary email wrong in event sheet"
#         )
#         assert event_row["Membership Secondary"] == secondary_email2, (
#             "Secondary email wrong in event sheet"
#         )
...
#     with client as c:
#         response = c.get(
#             f"membership/event-registration/{event_name}/{token}", follow_redirects=True
#         )
#         soup = BeautifulSoup(response.data, "html.parser")
...
#         assert row["Phone number subscribed"] == "", (
#             "Phone number subscribe field not deleted in members sheet"
#         )
#         assert row["Phone number verified"] == "", (
#             "Phone number verified field not deleted in members sheet"
#         )
#         event_records = get_wks_records(event_wks)
#         row = event_records[0]
#         assert row["Membership Primary"] == primary_email, (
...
#         )
#         assert row["Phone Number"] == int(phone_number[1:]), (
#             "phone number deleted in members sheet when it should be kept"
#         )
#         assert row["Phone number subscribed"] == "TRUE", (
#             "Phone number subscribe field deleted in members sheet when it should be kept"
#         )
#         assert row["Phone number verified"] == "TRUE", (
#             "Phone number verified field deleted in members sheet when it should be kept"
#         )
#         event_records = get_wks_records(event_wks)
#         row = event_records[0]
#         assert row["Membership Primary"] == primary_email, (
...
#         )
#         assert row["Phone Number"] == int(phone_number[1:]), (
#             "phone number deleted in events sheet when it should be kept"
#         )
...
#         assert not input, "The form has been rerendered"
#         assert heading is not None, (
#             "The OTP verification page was not rendered. The registration may have failed."
#         )
...
#         )
#         assert row["Secondary Email"] == "", (
#             "secondary email should be empty in members sheet"
#         )
#         assert row["Phone Number"] == int(new_phone_number[1:]), (
#             "new phone number not updated in members sheet"
#         )
#         assert row["Phone number subscribed"] == "TRUE", (
#             "Phone number subscribe field should be TRUE in members sheet"
#         )
#         assert row["Phone number verified"] == "FALSE", (
#             "Phone number verified field should be FALSE since it's a new number"
#         )
...
#             "Primary email wrong in event sheet"
#         )
#         assert row["Membership Secondary"] == "", (
#             "Secondary email should be empty in event sheet"
#         )
#         assert row["Phone Number"] == int(new_phone_number[1:]), (
#             "new phone number not updated in events sheet"
#         )
...
#         assert row["Phone number subscribed"] == "", (
#             "Phone number subscribe field not cleared in members sheet"
#         )
#         assert row["Phone number verified"] == "", (
#             "Phone number verified field not cleared in members sheet"
#         )
...
#         )
#         assert row["Secondary Email"] == "", (
#             "secondary email not deleted in members sheet"
#         )
#         assert row["Secondary Verified"] == "", (
#             "Secondary verified field not cleared in members sheet"
#         )
#         assert row["Secondary Subscribed"] == "", (
#             "Secondary subscribed field not cleared in members sheet"
#         )
#         assert row["Secondary Expired"] == "", (
#             "Secondary expired field not cleared in members sheet"
#         )
#         assert row["Phone Number"] == int(phone_number[1:]), (
#             "phone number changed in members sheet when it should stay the same"
#         )
#         assert row["Phone number subscribed"] == "TRUE", (
#             "Phone number subscribe field changed in members sheet"
#         )
#         assert row["Phone number verified"] == "TRUE", (
#             "Phone number verified field changed in members sheet"
#         )
...
#         )
#         assert row["Membership Secondary"] == "", (
#             "Secondary email not deleted in event sheet"
#         )
#         assert row["Phone Number"] == int(phone_number[1:]), (
#             "phone number changed in events sheet when it should stay the same"
#         )
...
#         original_phone_number  # User starts with a phone number
#     )
#     user[wks_columns["Phone number subscribed"] - 1] = "TRUE"
#     user[wks_columns["Phone number verified"] - 1] = "TRUE"
#     wks.append_row(user)
...
#         desired_phone_number  # This phone is already taken
#     )
...
#         num_event_records = len(event_records)
#         assert num_event_records == 0, (
#             "Event record was created despite phone number conflict"
#         )
...
#         assert original_user["Primary Email"] == primary_email, (
#             "Original user primary email changed"
#         )
#         assert original_user["Secondary Email"] == secondary_email, (
#             "Original user secondary email changed"
#         )
#         assert original_user["Phone Number"] == int(original_phone_number[1:]), (
#             "Original user phone number changed when it should remain the same"
#         )
...
#         records = get_wks_records(wks)
#         row = records[0]
#         assert row["Primary Email"] == new_primary_email, (
#             "primary email not updated in members sheet"
#         )
#         assert row["Secondary Email"] == secondary_email, (
...
#         event_records = get_wks_records(event_wks)
#         row = event_records[0]
#         assert row["Membership Primary"] == new_primary_email, (
#             "Primary email not updated in event sheet"
#         )
#         assert row["Membership Secondary"] == secondary_email, (
#             "Secondary email changed in event sheet when it should stay the same"
#         )
#         assert row["Phone Number"] == int(phone_number[1:]), (
#             "phone number changed in events sheet when it should stay the same"
#         )
...
#     user2 = ["" for i in range(len(wks_columns))]
#     taken_primary_email = (
#         "taken@email.com"  # This is the email first user will try to use
#     )
...
#         assert first_user["Primary Email"] == original_primary_email, (
#             "First user primary email changed"
#         )
#         assert first_user["Secondary Email"] == secondary_email, (
#             "First user secondary email changed"
#         )
#         # Verify second user data is unchanged
#         second_user = records[1]
#         assert second_user["Primary Email"] == taken_primary_email, (
#             "Second user primary email changed"
#         )
#         assert second_user["Secondary Email"] == "", (
#             "Second user secondary email changed"
#         )
...
#             "Event registration should not have been created due to email conflict"
#         )
...
#     taken_secondary_email = (
#         "takensecondary@email.com"  # This is the email first user will try to use
#     )
#     first_name2 = "SECOND USER FIRST"
#     last_name2 = "SECOND USER LAST"
#     start2 = "SECOND START"
...
#     user2[wks_columns["Primary Bounced"] - 1] = ""
#     user2[wks_columns["Secondary Email"] - 1] = (
#         taken_secondary_email  # This is what user 1 wants
#     )
...
#         # Verify second user data is unchanged
#         second_user = records[1]
#         assert second_user["Primary Email"] == other_primary_email, (
#             "Second user primary email changed"
#         )
#         assert second_user["Secondary Email"] == taken_secondary_email, (
#             "Second user secondary email changed"
#         )
#         assert second_user["Phone Number"] == "", "Second user phone number changed"
...
#         )
#         assert row["Secondary Email"] == new_secondary_email, (
#             "secondary email not updated in members sheet"
#         )
#         assert row["Phone number subscribed"] == "TRUE", (
#             "Phone number subscribe field changed in members sheet"
#         )
...
#         row = event_records[0]
#         assert row["Membership Primary"] == primary_email, (
#             "Primary email changed in event sheet when it should stay the same"
#         )
#         assert row["Membership Secondary"] == new_secondary_email, (
#             "Secondary email not updated in event sheet"
#         )
...
#         # Verify first user data is unchanged
#         first_user = records[0]
#         assert first_user["Primary Email"] == primary_email, (
#             "First user primary email changed"
#         )
#         assert first_user["Secondary Email"] == old_secondary_email, (
#             "First user secondary email changed"
#         )
...
#     user2 = ["" for i in range(len(wks_columns))]
#     taken_primary_email = (
#         "takenprimary@email.com"  # This is the email first user will try to use
#     )
#     first_name2 = "SECOND USER FIRST"
#     last_name2 = "SECOND USER LAST"
#     start2 = "SECOND START"
...
#     user2[wks_columns["When Started"] - 1] = start2
#     user2[wks_columns["Last Updated"] - 1] = update2
#     user2[wks_columns["Primary Email"] - 1] = (
#         taken_primary_email  # This is what user 1 wants
#     )
#     user2[wks_columns["Primary Verified"] - 1] = "TRUE"
#     user2[wks_columns["Primary Subscribed"] - 1] = "TRUE"
#     user2[wks_columns["Primary Expired"] - 1] = "FALSE"
...
#             "phone number field changed in members sheet when it should stay empty"
#         )
...
#         )
#         assert row["Phone Number"] == "", (
#             "phone number field changed in events sheet when it should stay empty"
#         )
...
#         )
#         assert row["Secondary Email"] == "", (
#             "secondary email field changed in members sheet when it should stay empty"
#         )
#         assert row["Phone Number"] == int(new_phone_number[1:]), (
#             "phone number not updated in members sheet"
#         )
#         assert row["Phone number verified"] == "FALSE", (
#             "phone number verification should be FALSE for new number"
#         )
...
#     primary_email2 = "other@email.com"
#     taken_phone_number = (
#         "+18057105809"  # This is the phone number first user will try to use
#     )
#     first_name2 = "SECOND USER FIRST"
#     last_name2 = "SECOND USER LAST"
#     start2 = "SECOND START"
...
#     user2[wks_columns["Info Completed"] - 1] = "TRUE"
#     user2[wks_columns["Phone Number"] - 1] = (
#         taken_phone_number  # This is what user 1 wants
#     )
#     user2[wks_columns["Phone number subscribed"] - 1] = "TRUE"
#     user2[wks_columns["Phone number verified"] - 1] = "TRUE"
...
#         assert first_user["Phone Number"] == int(original_phone_number[1:]), (
#             "First user phone number changed when it should remain the same"
#         )

#         # Verify second user data is unchanged
#         second_user = records[1]
#         assert second_user["Primary Email"] == primary_email2, (
#             "Second user primary email changed"
#         )
#         assert second_user["Secondary Email"] == "", (
#             "Second user secondary email changed"
#         )
#         assert second_user["Phone Number"] == int(taken_phone_number[1:]), (
#             "Second user phone number changed"
#         )

#         # Verify no event registration was created
#         event_records = get_wks_records(event_wks)
#         assert len(event_records) == 0, (
#             "Event registration should not have been created due to phone number conflict"
#         )
...
#             "Second user primary email changed"
#         )
#         assert second_user["Secondary Email"] == secondary_email2, (
#             "Second user secondary email changed"
#         )
#         assert second_user["Phone Number"] == int(taken_phone_number[1:]), (
#             "Second user phone number changed"
...
#         )
#         assert row["Phone number verified"] == "FALSE", (
#             "phone number verification should remain FALSE"
#         )
...
#             "Success page was not rendered for verified phone user"
#         )
#         assert otp_heading is None, (
#             "OTP page should NOT render for users with already verified phones"
#         )
