...
# def test_2_email_prim_sub_sec_sub(client):
#     """
#     test_2_email_prim_sub_sec_sub tests for when a user submits the form with 2 emails. The primary
#     email and secondary email are both checked as subscribed. The google sheet should have both
...
#                     f"Primary email should show as Subscribed in receipt. Found: {p.get_text()}"
#                 )
#                 break
...
#     assert row["Primary Subscribed"] == "TRUE"
#     assert row["Secondary Subscribed"] == "TRUE"


# def test_2_email_prim_sub_sec_unsub(client):
#     """
#     test_2_email_prim_sub_sec_sub tests for when a user submits the form with 2 emails. The primary
#     email is subscribed and the secondary email is unsubbed. The google sheet should have both
#     fields as TRUE under the respective subscribe columns. The template right after should also
#     show subscribe for the both contacts.
#     """
