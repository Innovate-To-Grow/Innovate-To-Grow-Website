...
#     with client as c:
#         response = c.post(
#             f"membership/update/{token}", data=form_data, follow_redirects=True
#         )
...
#             "The success page was not rendered. The update may have failed."
#         )
...
#     user2 = ["" for i in range(len(wks_columns))]
#     taken_primary_email = (
#         "taken@email.com"  # This is the primary email first user will try to use
#     )
...
#         assert not input, "The form has been rerendered"
#         assert heading is not None, (
#             "The error page was not rendered. The update may have failed."
#         )
...
#         )
#         assert first_user["Phone Number"] == int(phone_number[1:]), (
#             "First user phone number changed"
#         )
...
#         )
#         assert second_user["Secondary Email"] == other_secondary_email, (
#             "Second user secondary email changed"
#         )
#         assert second_user["Phone Number"] == int(other_phone_number[1:]), (
...
#         taken_secondary_email  # This is what user 1 wants as primary
#     )
#     user2[wks_columns["Secondary Verified"] - 1] = "TRUE"
#     user2[wks_columns["Secondary Subscribed"] - 1] = "TRUE"
#     user2[wks_columns["Secondary Expired"] - 1] = "FALSE"
...
#     user2[wks_columns["Last Updated"] - 1] = update2
#     user2[wks_columns["Primary Email"] - 1] = (
#         taken_primary_email  # This is what user 1 wants as secondary
#     )
#     user2[wks_columns["Primary Verified"] - 1] = "TRUE"
#     user2[wks_columns["Primary Subscribed"] - 1] = "TRUE"
#     user2[wks_columns["Primary Expired"] - 1] = "FALSE"
...
#             "First user primary email changed"
#         )
#         assert first_user["Secondary Email"] == original_secondary_email, (
#             "First user secondary email changed"
#         )
#         assert first_user["Phone Number"] == int(phone_number[1:]), (
#             "First user phone number changed"
...
# def test_update_swap_2_email_1_phone_change_secondary_email_to_existing_secondary(
#     client,
# ):
#     """
#     This tests for when a user originally registered with 2 emails and 1 phone
...
#     user2[wks_columns["Primary Bounced"] - 1] = ""
#     user2[wks_columns["Secondary Email"] - 1] = (
#         taken_secondary_email  # This is what user 1 wants as secondary
#     )
#     user2[wks_columns["Secondary Verified"] - 1] = "TRUE"
#     user2[wks_columns["Secondary Subscribed"] - 1] = "TRUE"
#     user2[wks_columns["Secondary Expired"] - 1] = "FALSE"
