...
describe('Router', () => {
    ...
    it.each([
        ['/past-projects/project/project-123', 'past-projects/project/:id'],
        ['/past-projects/share-123', 'past-projects/:shareId'],
        ['/account/past-project-curation-shared-links', 'account/past-project-curation-shared-links'],
