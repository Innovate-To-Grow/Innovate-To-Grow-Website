import './SampleProposalsPage.css';
...
const proposals: Proposal[] = [
  {
    ...
    organization: 'Sweep',
    background:
      'Sweep is an IoT Internet of things company that harnesses big data and machine learning to improve operational efficiency in industry. We rely on collecting valuable industrial equipment data through non-invasive sensors technologies to service our industrial/commercial customers. Product development of sensor technologies fuels our growth and innovation is crucial to reducing costs and improving capability.',
    problem:
      'Machine Centers of our production process require that product be moved manually between machine centers. This increases the time it takes to produce product and increases the risk for defects due to manual handling of product.',
    objectives:
      'Optimize a manufacturing production line for small to medium runs of electrical and mechanical manufacturing components. Analyze and provide recommendations for most efficiently timed process from circuit board placement, testing, assembly and logistics. Build, manufacture and test, automation components to limit user interaction. Automate production of mechanical injection molded components, pcb assemblies and final product assembly.',
  },
  {
    ...
    organization: 'BART',
    background:
      'The client is the SF Bay Area Rapid Transit (BART). They are in the business of moving people in electrified rail cars, across a collective 122 miles of rail tracks around and in the city of San Francisco. They are a public transportation industry headquartered in Oakland, CA. BART is in the midst of a capital improvement renewal effort to upgrade and replace $3B or more in capital infrastructure. There is a need to provide the highest level of professional project management, and to perform this work most efficiently, and accurately.',
    problem:
      'We are looking to bring the latest business technologies to our processes. Improving the efficiency of the project management process by implementing single data base synching from our current databases. Our systems using the maintenance database, Maximo, support the planning, scheduling, recording, and data collection for entire capital and maintenance teams. We need to gather real time data from these databases and collate the data for notifications. By achieving real time notifications and linking data, decisions, planning, and forecasting will be improved. We are flexible on the type of data and how to integrate data and establishing automated notifications.',
    objectives:
...
export const SampleProposalsPage = () => {
  return (
    <div className="proposals-page">
      <h1 className="proposals-page-title">Sample Project Proposals</h1>
        ...
        <div key={index} className="proposal-card">
          ...
          <div className="proposal-card-body">
            ...
            <p className="proposal-footer">
              Expectations and Submission: please review the{' '}
              <a
                href="https://docs.google.com/document/d/1HhZ8r7FP9kPeJTSrvy4nBc0A6jBArSd19Y9O9g1xgUc/edit"
                target="_blank"
                rel="noopener noreferrer"
              >
                expectations and terms of the I2G Program
              </a>{' '}
              for your organization's participation, and{' '}
              <a
                href="https://ucmerced.az1.qualtrics.com/jfe/form/SV_4OA7I03KTLgQcGF?"
                target="_blank"
                rel="noopener noreferrer"
              >
                submit the project with the form
              </a>{' '}
